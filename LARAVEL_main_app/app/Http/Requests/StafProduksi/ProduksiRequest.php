...
class ProduksiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bahan_baku.*.lot_bahan_baku.id' => 'required|integer|exists:lot_bahan_bakus,id|distinct',
            'bahan_baku.*.lot_bahan_baku.bahan_baku.nama_bahan' => 'required|string|distinct',
