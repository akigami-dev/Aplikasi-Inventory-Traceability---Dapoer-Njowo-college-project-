...
<template>
    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-primary-200 dark:bg-surface-950 text-surface-600 dark:text-surface-0 font-medium">
        ...
        <div class="tablet:w-md phone:w-xs main-wrapper rounded-lg drop-shadow-xl shadow-2xl">
                ...
                <div class="card px-5">
                    <form @submit.prevent="submit">
                        <div class="flex flex-col gap-2">
                            ...
                            <Button type="submit" class="w-full bg-primary hover:bg-primary-0 my-2 font-semibold" :disabled="form.processing">Login</Button>
                        </div>
                        <div class="flex items-center justify-between" :tabindex="3">
                            <Label for="remember" class="flex items-center justify-center space-x-2 text-sm">
                                <Checkbox id="remember" v-model="form.remember" class="size-4" :tabindex="4" />
                                <span>Remember me</span>
                            </Label>
                            <div class="text-sm text-center mt-2">
                                <Link :href="route('forgot-password')" class="font-semibold text-primary hover:text-primary-300 hover:dark:text-primary-50"> 
                                    Forgot password ?
                                </Link>
                            </div>
                        </div>
                    </form>
                    <!-- <div class="w-full text-sm text-center mt-4">
                        Dont have account?
                        <Link :href="route('register')" class="font-semibold text-primary hover:text-primary-300 hover:dark:text-primary-50"> 
                            SignUp
                        </Link>
                    </div> -->
                </div>
