...
import { parseDate, parseDateForDatePicker } from '@/composables/Helper';
...
function submitSearch(){
    console.log("Data Laporan: ", DataMeta.value);
    formatFilters();
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex-1">
                <DataTable class="rounded-lg shadow !overflow-auto text-sm" show-gridlines striped-rows :value="DataLaporan">
                    ...
                    <Column style="max-width: 15rem; width: 12rem;" field="keterangan" header="Keterangan" class="wrap-break-word">
                        <template #body="{ data }">
